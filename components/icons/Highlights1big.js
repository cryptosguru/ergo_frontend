...
const SvgHighlights1 = (props) => (
  <svg width={562} height={562} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g filter="url(#highlights-1big_svg__a)">
      <circle
        cx={281.287}
        cy={280.374}
        r={184.826}
        transform="rotate(40.411 281.287 280.374)"
        fill="url(#highlights-1big_svg__b)"
      />
    </g>
    <g filter="url(#highlights-1big_svg__c)">
      <path
        d="M410.033 129.163a199.241 199.241 0 1 1-46.654-29.65L280.87 280.866l129.163-151.704Z"
        fill="url(#highlights-1big_svg__d)"
        shapeRendering="crispEdges"
      />
    </g>
    <defs>
      <linearGradient
        id="highlights-1big_svg__b"
        x1={146.755}
        y1={135.148}
        x2={445.478}
        y2={680.799}
